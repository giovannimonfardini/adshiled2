  ...
  return (
    <section className="flex flex-col items-center py-16">
      <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-10 text-center tracking-tight">
        Recursos que impulsionam seu tráfego
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl px-4">
        <CardDemo
          title="Gestão de Contas"
          description="Gerencie múltiplas contas de anúncios com facilidade e segurança, tudo em um só lugar."
          metaCenter
        />
        <CardDemo
          title="Escalabilidade"
          description="Escale suas campanhas sem limites, aproveitando infraestrutura robusta e suporte especializado."
        />
        <CardDemo
          title="Suporte Premium"
          description="Conte com atendimento dedicado e soluções rápidas para qualquer desafio no seu tráfego pago."
          slackIcon
        />
      </div>
    </section>
...
export function CardDemo({ title, description, icon, metaCenter, slackIcon }: CardDemoProps) {
  return (
    <Card>
      <CardSkeletonContainer>
        <Skeleton metaCenter={metaCenter} slackIcon={slackIcon} />
      </CardSkeletonContainer>
...
const Skeleton = ({ metaCenter = false, slackIcon = false }: { metaCenter?: boolean; slackIcon?: boolean }) => {
  const scale = [1, 1.1, 1];
        ...
        {slackIcon ? (
          <>
            <Container className="circle-3">
              <Image src="/images/slack-icon.png" alt="Slack" width={32} height={32} className="h-8 w-8" />
            </Container>
          ...
          <>
            ...
            <Container className="h-12 w-12 circle-4">
              <Image src="/images/google-icon.png" alt="Google" width={32} height={32} className="h-8 w-8" />
            </Container>
          </>
        ) : (
          <>
